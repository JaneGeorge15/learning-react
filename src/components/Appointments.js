...
class Appointments extends Component {
  ...
  render() {
    ...
    return (
        ...
        toggleForm={this.toggleForm} addAppointment={this.addAppointment}/>
        <SearchAppointments orderBy={this.state.orderBy} orderDir={this.state.orderDir}
        changeOrder={this.changeOrder} searchApts={this.searchApts}/>
        <ListAppointments appointments={filteredApts} 
        deleteAppointments={this.deleteAppointments} updateInfo={this.updateInfo}/>
       </div>
    );
  }
